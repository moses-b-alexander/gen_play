...
state_mapping = {
    ...
    33: ("bool", "player_position_ls", False, True, "bernoulli"),
    34: ("bool", "player_position_na", False, True, "bernoulli"),
    35: ("bool", "player_position_ol", False, True, "bernoulli"),
    36: ("bool", "player_position_pt", False, True, "bernoulli"),
    37: ("bool", "player_position_qb", False, True, "bernoulli"),
    38: ("bool", "player_position_rb", False, True, "bernoulli"),
    39: ("bool", "player_position_te", False, True, "bernoulli"),
    40: ("bool", "player_position_wr", False, True, "bernoulli"),
    41: ("bool", "player_post_snap", False, True, "bernoulli"),
    42: ("bool", "player_pre_snap", False, True, "bernoulli"),
    43: ("float", "player_vx", -1.0, +1.0, "normal"),
    44: ("float", "player_vy", -1.0, +1.0, "normal"),
    45: ("float", "player_x", -0.2, +1.2, "uniform"),
    46: ("float", "player_y", -1.0, +1.0, "normal"),
    47: ("bool", "player_defense", False, True, "bernoulli"),
    48: ("bool", "player_offense", False, True, "bernoulli"),
}
